...
1. скопіюйте код у першу комірку, змініть значення змінної `name` на Ваше імя та натисніть кнопку `Run All` вверху або `Execute Cell` зліва (трикутник);
```python
import datetime
name = "Bohdan"
print("Hello", name)
print("You write your first program ", datetime.datetime.today())
```
...
1. натисніть на кнопку `Run Python File` (трикутник) щоб запустити програму; 
1. вкажіть у звіті що вивела пограма або зробіть скріншот та вставте у звіт;
---
