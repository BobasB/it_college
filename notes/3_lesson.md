...
1. скопіюйте код у першу комірку, змініть значення змінної `name` на Ваше імя та натисніть кнопку `Run All` вверху або `Execute Cell` зліва (трикутник :arrow_forward:);
