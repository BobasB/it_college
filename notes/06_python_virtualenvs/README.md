...
1. `pipenv` дозволяє визнатичти дерево залежностей для встановлених бібліотек. Для цього виконайте команду:
    ```bash
    pipenv graph
    ```
...
1. Виявлення вразливостей у залежностях - це важливий аспект безпеки програмного забезпечення. `pipenv` має вбудовану функцію для перевірки вразливостей у встановлених залежностях. Для цього виконайте команду:
    ...
    pipenv check
    ```
    - такожж можна просканувати всі залежності на безпекові вразливості за допомогою:
    ```bash
    pipenv scan
    ```
